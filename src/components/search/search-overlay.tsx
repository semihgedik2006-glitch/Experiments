  ...
  return (
    <>
      <motion.button
        ...
        className="tastflaeche flex h-9 w-9 items-center justify-center rounded-full border border-border text-foreground transition-colors hover:border-lime hover:text-accent"
      >
        <Search size={16} />
      </motion.button>
