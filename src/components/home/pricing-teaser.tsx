          ...
          {pricingPlans.map((plan) => (
            <StaggerItem key={plan.name}>
              <motion.div
                ...
                className={`flex h-full flex-col rounded-2xl border p-8 shadow-sm transition-shadow hover:shadow-xl ${
                  plan.highlighted
                    ? "border-lime bg-surface-raised hover:shadow-lime/10"
                    : "border-border bg-surface-raised hover:shadow-lime/5"
                }`}
              >
